...
const AddProduct = () => {
    ...
    const id = get(location, "state.id", null);
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if (id) {
                // await axios.post(`http://localhost:3003/manufacturer/productById`,
                await axios
                ...
                const filteredMaterial = optionArray.filter((item) => {
                    let check = false;
    ...
    const createProduct = async () => {
        ...
        await axios
            .post(
                `http://localhost:3003/manufacturer/addProduct`,
                {
                    name: name,
                    detail: detail,
                    image1: img1,
    ...
    const updateProduct = async () => {
        ...
        // await axios.post(`http://localhost:3003/manufacturer/updateProduct/` + id,
        await axios.post(
            `http://localhost:3003/manufacturer/updateProduct/` + id,
            {
                name: name,
                detail: detail,
                        ...
                        {page === 1 ? (
                            <div style={{ height: "100%" }}>
                                ...
                                >
                                    ...
                                    >
                                        PRODUCT NAME <span style={{ color: "#EB5757" }}>*</span>
                                    </label>
                                    <br />
                                    <input
                                        type="text"
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Tooltip id="material" place="right" effect="solid">
                                            Please select all related materials <br />
                                            i.e. product with plastic bootle should select "PET
                                            Bottle" and "HDPE Bottle Cap".
                                        </Tooltip>
                                    </label>
                                    <br />
                                    <Multiselect
                                    ...
                                    >
                                        ...
                                        <img
                                            alt="tooltip"
                                            data-tip="React-tooltip"
                                            data-for="howToRecycle"
                                            src="/icons/tooltip.png"
                                            width={12}
                                            height={12}
                                        />
                                        <Tooltip id="howToRecycle" place="right" effect="solid">
                                            How to recycle your product when it become a garbage.
                                        </Tooltip>
                                    </label>
                                    <textarea
                                        name="preparing"
                                        ...
                                        placeholder=""
                                        value={howToRecycle}
                                        onChange={(e) => setHowToRecycle(e.target.value)}
                                        style={{
                                            resize: "none",
                                            width: "100%",
                                            height: "150px",
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="modal-li" style={{ marginBottom: "30px" }}>
                                Your product has been {id ? "updated" : "created"}. You can view
                                this product now or go back to your home page.
                            </p>
                            <div style={{ width: "100%", display: "flex" }}>
                                <Link to={"/manuHome"}>
                                    <div
